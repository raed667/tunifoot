						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
                          ...
                          <?php foreach ($liste as $Voi): ?>
							<tr>
                              ...
                              <th> - </th>
								<td class="center">
									<a target="_blank" class="btn btn-success" href="../vue/Joueur.php?Id=<?php echo($EM->retournerId($Voi->getEmail()));  ?>">
										<i class="icon-zoom-in icon-white"></i>  
										View                                            
									</a>
                                    </td>
                                    <td>
									<a target="_blank" class="btn btn-info" href="modifier_J.php?Id=<?php echo($EM->retournerId($Voi->getEmail()));   ?>&">
