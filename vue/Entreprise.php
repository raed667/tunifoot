...
<title><?php echo(" "); echo $E->getNom_Entreprise(); ?></title>
...
<div class="row-fluid">
   <div class="span12">
      <div class="row-fluid">
         <div class="span2"></div>
         <?php if($EM->ExisteEntreprise($Id)==true)
		 { ?>
           <div class="span8">
<!--     DEBUT DU BODY     --> 
<br>
...
<?php if (file_exists('../control/uploads/imgEntreprise'.$Id.".jpg")) {
?>
<img src="<?php echo('../control/uploads/imgEntreprise'.$Id.".jpg"); ?>" class="img-polaroid" style="height:128px; width:128px;">
<?php }
else {
?>
<img id="PPimg" src="images/reason2.png" class="img-polaroid" style="height:128px; width:128px;">
<?php } ?>

	</div>
<h1><?php echo(" "); echo $E->getNom_Entreprise(); ?></h1>
<br><br><br>
<!--ICI VA LE CONTENU  --> 
...
<div class="row-fluid">
    ...
    <textarea class="form-inline"  name="message" cols='10000' rows='4' style="resize: none; width:95%;" required>Vous êtes invités pour jouer un match amical dans le cadre de l'équipe de l'entreprise,veuillez  un Email de confirmation...</textarea>
    <br>
...
if (isset($_GET['PE']) and $_GET['PE']==1) {
	?>    
<input type="checkbox" id="afficher_dialog" checked />
<?php
 ...
 ?>
     ...
     <div id="dialog" title="Résérvation(s) Validée(s)">
<br>
			<h4><p>Votre réservation a était proprement validée, Vous pouvez consulter l'ensemble de vos réservations dans votre profil pour les payer.</p></h4>
		</div>
	...
	<br>
           <table>            
            <tr>
            	<td><div><h4>Gérée par <?php echo $E->getPrenom();echo(" "); echo $E->getNom();?></h4></div></td>
            </tr>
            
			  <tr>
				<td><div><h4><i class="icon-map"></i> Cituée à <a target="_blank" href="https://maps.google.tn/maps?hl=fr&q=<?php echo $E->getRegion();?>+Tunisie&bav=on.2,or.r_qf.&biw=1366&bih=667&um=1&ie=UTF-8&sa=N&tab=wl&authuser=0"><?php echo $E->getRegion(); ?></a></h4></div></td>
			  </tr>
...
<table id="table_inscri" style="margin-left:auto; margin-right: auto;" width="500" border="0">
              ...
              <tr>
				<td><label>Nom du Gérant</label></td>
			  ...
			  <tr>
				<td><label>Prenom du Gérant</label></td>
              ...
              <tr>
				<td><label>E-Mail du Gérant</label></td>
				<td><input type="email" name="Email_util" id="Email_util"  value="<?php echo $E->getEmail(); ?>"/></td>
			  </tr>
			  
			  <tr>
				<td><label>Nouv. Mot de Passe</label></td>
				<td><input type="password" name="Motdepasse_util" id="Motdepasse_util"/></td>
			  </tr>
			
			  <tr>
				<td><label>Adresse de l'Entreprise</label></td>
				<td><input name="Residence_util" id="Residence_util" type="text"  value="<?php echo $E->getResidence(); ?> "/></td>
			  </tr>
			  ...
			  <tr>
				...
				<td><input name="Telephone_util" id="Telephone_util" type="tel"  value="<?php echo $E->getTelephone(); ?> "/></td>
			  </tr>
...
<span>
     ...
     <form action="../control/upload_img.php?IdE=<?php echo $_SESSION['IdU'] ?>" class="dropzone"> </form>
</span>
</center>
     </div>
